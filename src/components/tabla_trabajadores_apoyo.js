...
export default function Tabla_trabajadores_apoyo({ data, onNavigate, usuario }) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <Text style={[styles.cell,styles.dataColumn]}>{item.nombre_trabajador}</Text>
      ...
      {(puede(usuario,'editar_trabajador') || puede(usuario,'borrar_trabajador')) && (
  ...
  const renderHeader = () => (
      <View style={styles.header}>
        ...
        <Text style={[styles.headerCell,styles.dataColumn]}>Centro Comunitario</Text>
